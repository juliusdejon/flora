...
import { rosaBeautyProducts } from '../partnerProducts';

interface RosaBeautyProps extends INavigation {}
const RosaBeauty: React.FC<RosaBeautyProps> = ({ navigation }) => {
      ...
      <Page backgroundColor={theme.palette.common.white}>
        ...
        <ScrollView style={{ paddingTop: 10 }}>
          <View
            ...
            <Image
              source={require('../../../../assets/beauty-rosa-banner.png')}
              style={{
                width: '65%',
                height: 80,
                resizeMode: 'cover',
          ...
          {/* Wigs Carousel */}
          <ImageBackground
            source={require('../../../../assets/rosa-banner.png')}
            resizeMode="cover"
            style={{
              height: 410,
          ...
          <View
            ...
            <ScrollView showsHorizontalScrollIndicator={false} horizontal>
              {rosaBeautyProducts.map(product => (
                <View key={product.id}>
                  <Product
                    id={product.id}
                    onPress={() =>
